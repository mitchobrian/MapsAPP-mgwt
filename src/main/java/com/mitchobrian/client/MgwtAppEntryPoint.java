 ...
 * the License.
 */
package com.mitchobrian.client;
...
import com.mitchobrian.client.css.AppBundle;
...
public class MgwtAppEntryPoint implements EntryPoint {
    ...
    MGWT.applySettings(MGWTSettings.getAppSetting());
		...
		historyHandler.register(clientFactory.getPlaceController(), clientFactory.getEventBus(), new com.mitchobrian.client.activities.HomePlace());
